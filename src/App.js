...
class App extends Component{
  ...
  /**
   * c'est movieElement qui écoute cette fonction:avec onMouseEnter mis en place de la fonction avec findIndex qui est le titre du film modifie setState
   */
    ...
    return(
      <div className="container App d-flex flex-column">
        ...
        <div className = "content d-flex flex-row border flex-fill pt-3">
          <MoviesList _movies ={this.state.movies} updateSelectedMovie= {this.updateSelectedMovie} />
          <MoviesDetails _movie = {this.state.movies[this.state.selectedMovie]} />
        </div>
        <Footer />
